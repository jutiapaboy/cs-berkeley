...
(define (outline frame)
  ((segments->painter (list
		       ...
		       (make-segment (add-vect (edge1-frame frame)
					       (edge2-frame frame))
			       	     (edge1-frame frame))
...
(define (x-frame frame)
  ((segments->painter (list
		       ...
		       (make-segment (origin-frame frame)
				     (add-vect (edge1-frame frame)
					       (edge2-frame frame)))
...
(define (wave frame)
  (let ((e1 (scale-vect (/ 1 16) (edge1-frame frame)))
        (e2 (scale-vect (/ 1 16) (edge2-frame frame))))
    ((segments->painter (list
...
;; I am changing the coordinates of full-frame so it makes a square I draw it on Turtlegraph. This makes it easier to error-checking.



(define full-frame1 (make-frame (make-vect 0 0)
			       (make-vect 1 0)
			       (make-vect 0 1)))
