...
public class DList extends List {
  ...
  /**
   * insertReturn() does the same thing as insertBack(),
   * except it also returns the DListNode it created.
   * 
   * @param item the item to be inserted
   * @return the DListNode of the item
   */
  public DListNode insertReturn(Object item) {
	  DListNode node = newNode(item, this, null, null);
	  DListNode old = head.prev;
	  node.prev = old;
	  node.next = head;
  ...
  public Object nth(Object position) {
  ...
  public static void main(String[] argv) {
    ...
    p.insertFront(2);
    p.insertFront(5);
    System.out.println("p is a list of 4 elements: " + p);
    
    System.out.println("\n");
    System.out.println("TESTING nth METHOD");
    System.out.println(((DList) l).nth(1));
    System.out.println(((DList) l).nth(2));
    System.out.println(((DList) l).nth(3));
    System.out.println("\n");    
//    ((DList) l).remove(2, (DList) p, 5);
//    ((DList) l).remove(3);
//    ((DList) l).remove(3);
    System.out.println(l);
    System.out.println(p);
    System.out.println("\n");
    System.out.println((int) (4*(Math.random()) +2));
    System.out.println((int) (4*(Math.random()) +2));
    System.out.println((int) (4*(Math.random()) +2));
    System.out.println((int) (4*(Math.random()) +2));
    System.out.println((int) (4*(Math.random()) +2));
